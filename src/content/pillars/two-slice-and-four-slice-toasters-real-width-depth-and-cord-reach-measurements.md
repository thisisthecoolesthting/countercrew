---
title: 'Two-slice and four-slice toasters: real width depth and cord reach measurements'
metaDescription: 'Two-slice and four-slice toasters: real width depth and cord reach
  measurements. Practical guide covering Two-slice and four-slice toasters: real width
  ...'
publishedAt: '2026-06-01'
updatedAt: '2026-06-01'
excerpt: 'Two-slice and four-slice toasters: real width depth and cord reach measurements'
targetKeyword: "Two-slice and four-slice toasters: real width depth and cord reach measurements"
...
- depth
site: countercrew
topic: 'Two-slice and four-slice toasters: real width depth and cord reach measurements'
tier: full
relatedProducts: []
status: published
keyTakeaways:
- Two-slice toasters typically range from 6 to 8 inches wide but often have more depth
  than you expect, around 9 to 11 inches.
- Four-slice toasters can be twice or more the width of two-slice models, often hitting
  12 to 18 inches but vary widely depending on styling.
- Depth is crucial for fitting behind counter backsplashes or under cabinets; many
  models are deeper than their widths.
- Cord length averages between 24 and 36 inches, affecting where in your kitchen you
  can place your toaster without extension cords.
- Checking actual footprint dimensions and cord reach before buying helps avoid awkward
  repositioning or limited use.
hero_image_keywords:
- two-slice four-slice toasters
- toasters real width
