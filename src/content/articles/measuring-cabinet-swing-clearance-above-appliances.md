---
title: Measuring cabinet swing clearance above appliances
metaDescription: Measuring cabinet swing clearance above appliances. Practical guide
  covering Measuring cabinet swing clearance above appliances.
publishedAt: '2026-06-01'
updatedAt: '2026-06-01'
excerpt: Measuring cabinet swing clearance above appliances
...
- appliances
site: countercrew
topic: Measuring cabinet swing clearance above appliances
tier: full
relatedProducts: []
status: published
keyTakeaways:
- Always measure the full arc of cabinet doors when opened to avoid interfering with
  appliances.
- Different appliance models require specific minimum clearances; check manufacturer
  specs.
- Swing clearance isn’t just horizontal—vertical clearance above the appliance impacts
  door swing too.
- Use simple tools like tape measures and angle finders for precise cabinet swing
  measurements.
- Planning cabinet door hinges and stop placements can maximize usable space around
  appliances.
hero_image_keywords:
- measuring cabinet swing
- swing clearance above
...
1. **Identify the full arc of the cabinet door swing**: Open the cabinet door slowly and note the distance from the hinge to the furthest edge of the door as it swings out.

2. **Measure horizontal clearance**: Using a tape measure, check the horizontal space between the cabinet door’s edge when fully open and the edge or surface of the appliance below.

3. **Measure vertical clearance**: Check the gap between the top surface of the appliance and the underside of the cabinet. This is crucial for appliances like refrigerators with raised tops or microwaves that require a specific clearance.

4. **Account for door stops and hardware**: Sometimes door knobs, handles, or magnetic catches add extra protrusion. Include these in your measurements.

5. **Factor in countertop thickness and backsplash**: If the cabinet door swings over a thick countertop edge or backsplash, that can reduce available clearance.
